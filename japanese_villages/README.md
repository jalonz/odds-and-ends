# Japan Village Economy — Era Flourishing Index
...
- **Role specialization** — how deeply distinct trades and social personas were embedded in village life
- **Surplus generation** — whether the village produced beyond subsistence, enabling internal exchange
- **Governance autonomy** — whether collective self-governance operated without external enforcement
- **Trade ecology closure** — how self-contained the village's input and output loops were
...
- Where are the hard external dependencies that cannot be internalized?
- Under what conditions does the system degrade gracefully?
- How does the governance layer enforce compliance without central authority?
